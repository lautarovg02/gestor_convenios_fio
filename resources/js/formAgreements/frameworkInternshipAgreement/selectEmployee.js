        ...
        fetch(`/api/employee/${selectedOption}`)
            ...
            .then((employee) => {
                ...
                document.querySelector('input[name="contact_apellido"]').value =
                    employee.lastname || "";
                document.querySelector('input[name="contact_dni"]').value =
                    employee.dni || "";
        ...
        fetch(`/api/employee/${selectedOption}`)
            ...
            .then((employee) => {
                ...
                document.querySelector('input[name="firma_nombre"]').value =
                    employee.name || "";
                document.querySelector('input[name="firma_apellido"]').value =
                    employee.lastname || "";
                document.querySelector('input[name="firma_dni"]').value =
                    employee.dni || "";
