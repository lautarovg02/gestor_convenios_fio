...
<div class="mb-4 border rounded containerSectionForm">
    ...
    <div class="mb-3">
        <label class="form-label fs-6 fw-bold">Localidad<span class="InputImportant">*</span></label>
    ...
    <div class="mb-3">
        <label class="form-label fs-6 fw-bold">Provincia<span class="InputImportant">*</span></label>
