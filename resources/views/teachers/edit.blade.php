                    ...
                    <form method="POST" action="{{ route('teachers.update', $teacher) }}" enctype="multipart/form-data">
                            ...
                            <div style="display: flex; align-items: center; gap: 10px;">
                                <div>
                                    <input class="form-check-input" type="radio" id="rector_1" name="is_rector"
                                        value="1" {{ old('is_rector', $teacher->is_rector) == 1 ? 'checked' : '' }}>
                                ...
                                <div>
                                    <input class="form-check-input" type="radio" id="rector_2" name="is_rector"
                                        value="0" {{ old('is_rector', $teacher->is_rector) == 0 ? 'checked' : '' }}>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="alert alert-light   shadow-sm w-75 " role="alert">
                                <strong>Campo Rol:</strong> Los roles de <strong>Director de Departamento</strong> y
                                ...
                                <a href="{{ route('departments.index') }}"
                                    class="text-decoration-underline">departamento</a> (para director)
                                o una
                                <a href="{{ route('careers.index') }}" class="text-decoration-underline">carrera</a>
                                (para coordinador).
                            </div>
                        </div>
