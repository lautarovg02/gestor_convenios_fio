        ...
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-column align-items-center">
                ...
                <div class="text-center mt-2">
                    ...
                    <p class="mt-4"> ¿Confirma a  <span class="fw-bold" id="coordinator-lastname"></span>
                        <span class="fw-bold" id="coordinator-name"></span>
                        como Coordinador  de la carrera
                        <span class="fw-bold" id="career-name"></span> ?</p>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                <!-- El formulario enviará la acción dinámica -->
                <form method="POST" id="modal-edit-form" action="{{ route('careers.update', $career) }}" role="form" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PATCH') }}
