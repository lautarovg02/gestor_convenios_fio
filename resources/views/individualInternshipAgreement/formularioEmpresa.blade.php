...
<div class="container mt-4">
  ...
  <form action="{{ route('individualInternshipAgreement.store') }}" method="POST">
...
<div class="mb-4 border rounded containerSectionForm p-3">
  ...
  <div class="mb-3">
    ...
    <input type="number" name="student_dni" class="form-control" value="{{ old('student_dni') }}" required>
  ...
  <div class="mb-3">
    ...
    <div class="input-group">
      <input type="text" name="student_cuil_prefijo" class="form-control" maxlength="2" value="{{ old('student_cuil_prefijo') }}" required>
      <span class="input-group-text">-</span>
      <input type="text" name="student_cuil_dni" class="form-control" maxlength="8" value="{{ old('student_cuil_dni') }}" required>
      <span class="input-group-text">-</span>
      <input type="text" name="student_cuil_dv" class="form-control" maxlength="1" value="{{ old('student_cuil_dv') }}" required>
    </div>
  ...
  <div class="mb-3">
    ...
    <input type="number" name="student_phone" class="form-control" value="{{ old('student_phone') }}" required>
@error('student_phone')
  <div class="text-danger">{{ $message }}</div>
@enderror
  </div>
  <div class="mb-3">
    ...
    <input type="text" name="student_career" class="form-control" value="{{ old('student_career') }}" required>
  ...
  <div class="mb-3">
    ...
    <input type="text" name="student_domicilio_calle" class="form-control" 
           value="{{ old('student_domicilio_calle') }}" required>
  ...
  <div class="mb-3">
    ...
    <input type="text" name="student_domicilio_numero" class="form-control" 
           value="{{ old('student_domicilio_numero') }}" required>
  ...
  <div class="mb-3">
    ...
    <input type="text" name="student_ciudad" class="form-control" value="{{ old('student_ciudad') }}" required>
    ...
    <div class="mb-4 border rounded containerSectionForm p-3">
     ...
     <div class="mb-3">
        ...
        <input type="text" name="fecha_firma_marco" class="form-control" 
               value="{{ $contract->signing_date ? \Carbon\Carbon::parse($contract->signing_date)->format('d/m/Y') : '' }}" readonly>
    </div>
