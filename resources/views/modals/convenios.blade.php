@vite('resources/css/modals/modalSeleccionarConvenio.css')
...
<div class="modal fade" id="crearConvenioModal" tabindex="-1" aria-labelledby="crearConvenioModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-3 shadow">
            ...
            <div class="containerSeleccionarConvenio">

                <div class=" selectConvenio modal-body d-flex flex-column gap-3">
                    <a href="{{ route('frameworkAgreement.create', ['type' => 'marco']) }}"
                        class=" lk btn btn-outline-primary fw-semibold btn-lg" role="button">
                        Convenio Marco
                    </a>
                    ...
                    <a href="{{ route('individual-internship-agreements.create', ['type' => 'indPasantia']) }}"
                        class="lk btn btn-outline-primary fw-semibold btn-lg" role="button">
