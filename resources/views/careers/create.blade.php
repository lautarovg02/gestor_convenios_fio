            ...
            <div class="card-body">
                <form method="POST" action=" {{route('careers.store')}} " id="" role="form">
                    ...
                    <div class="form-group mb-3 fs-6">
                        ...
                        <div>
                            <input class="form-control " placeholder="Carrera a ingresar..." name="name" type="text" id="name">
                    ...
                    <div class="form-group mb-3 fs-6">
                    <label class="form-label required-field">   <label for="departament_id">Departamento</label></label>
                    <div>
